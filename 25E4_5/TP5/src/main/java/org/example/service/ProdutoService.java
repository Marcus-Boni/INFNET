...
public class ProdutoService implements ProdutoCatalogo {
    ...
    public Produto salvar(Produto produto) {
        ProdutoComando comando = produtoSanitizador.sanitizar(produto);
        produtoValidador.validarComando(comando);
    ...
    public Produto atualizar(Long id, Produto dadosNovos) {
        ...
        ProdutoComando comando = produtoSanitizador.sanitizar(dadosNovos);
        produtoValidador.validarComando(comando);
        produtoMutator.aplicarAtualizacao(existente, comando);
