...
public class Project {
    ...
    /** Returns true when unit tests pass. Prefer this over comparing runTests() to a string. */
    ...
    /** Returns true when deployment to production succeeds. Prefer this over comparing deploy() to a string. */
    public boolean deploysToProductionSuccessfully() {
